...
class DateParser
{
    ...
    public static function relativeTime($date){
        ...
        if (!empty($date) && $date != '0000-00-00 00:00:00' && $date != '0000-00-00'){
            ...
            return '<sapan class="uk-text-danger">Date inconnue</sapan>';
        }
    }
    ...
    public static function DateConviviale($date,$withTime=null){
        ...
        if (!empty($date) && $date != '0000-00-00 00:00:00' && $date != '0000-00-00') {
            ...
            $time = isset($withTime)?" at ".date("H:i",strtotime($date)):"";
    ...
    public static function shortDate($date){
        ...
        if (!empty($date) && $date != '0000-00-00 00:00:00' && $date != '0000-00-00') {
            ...
            return '<sapan class="uk-text-danger">Pas renseigné</sapan>';
        }
    }
    ...
    public static function calculAge($date_naissance)
    {
        ...
        $ans = $intervalle->format('%y');
        $result = ($ans > 1) ? $ans . ' ' . self::getLang('ans', $local) . 's' : $ans . ' ' . self::getLang('an', $local);
        return $result;
    }
