...
class Paginator{
    ...
    public $urlSuivant = "";
    private $url = "";
    public $disabledPrecedent = " class='uk-disabled'";
    public $disabledSuivant = " class='uk-disabled'";
    private $params = [];
    private $param = [];
    ...
    private function getLi($href,$val,$isActive){
        ...
        return '<li'.$active.'><a style="color:white" class="bg-success"'.$href.'>'.$val.'</a></li>';
    }
    ...
    public function paginateTwo(){
        $ulBegin = '<ul class="uk-pagination uk-margin-medium-top">';
        $ulEnd = '</ul>';
        $disabledBegin = " class='uk-disabled'";
        $disabledEnd = " class='uk-disabled'";
        $urlBegin = "";
        $urlEnd = "";
        $content = "";
        $j = 0;
        ...
        $liBegin = '<li'.$disabledBegin.'><a'.$urlBegin.' class="uk-icon-angle-double-left"></a></li>';
        $liEnd = '<li'.$disabledEnd.'><a'.$urlEnd.' class="uk-icon-angle-double-right"></a></li>';
