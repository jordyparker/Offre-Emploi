    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <h2 class="mb-4"><span><?php echo !empty($emplois)?"Tous Les Emplois":""?></span></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <form action="<?= App::url('emplois') ?>" class="search-job form-row" id="search">
        ...
        <div class="row">
            <a href="<?= App::url('emplois') ?>"><i class="fa fa-refresh pull-right" style="font-size: 20px"><?=" "?>Refresh</i></a>
            <div class="col-md-12 ftco-animate" style="color:#000000">
                ...
                <?php }
                    ...
                    echo '<h3 class="uk-width-medium-1-1 uk-text-danger uk-text-center">Aucun résultat pour votre recherche</h3>';
                }?>
